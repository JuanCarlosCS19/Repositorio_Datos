...
os.chdir("G:/Mi unidad/Computadora_Potatil_DRIVE/Cursos_Scidata/Machine_Learning2023/ML_Py_23/data")
...
busqueda = RandomizedSearchCV(estimator=clf,
                             ...
                             n_iter=3, #numero de iteraciones
                             cv=3, #cross validation
                             n_jobs=-1, #cantidad de nucleos que utilizara la pc
                             scoring="f1_micro")
...
mejores_params = {'n_neighbors': 2, 'p': 2, 'weights': 'distance'}
...
import pickle
with open("G:/Mi unidad/Computadora_Potatil_DRIVE/Cursos_Scidata/Machine_Learning2023/ML_Py_23/data/Resultados_Sesion17_v2/pca.pickle", "wb") as file:
    pickle.dump(pca, file)
    
with open("G:/Mi unidad/Computadora_Potatil_DRIVE/Cursos_Scidata/Machine_Learning2023/ML_Py_23/data/Resultados_Sesion17_v2/mejor_knn.pickle", "wb") as file:
